---
title: "Dashboard Definition File"
author: "Jerome Dixon"
execute:
  eval: false
format:
...
prod: 478158c8-17cd-4954-b0bd-d9f733b7b30a test: 8abba5d7-2e1c-411b-b122-0a589a708651

```{bash eval=FALSE}

aws quicksight describe-dashboard-definition --dashboard-id '8abba5d7-2e1c-411b-b122-0a589a708651' --aws-account-id xxxxxxxxxxxx | jq '.Definition' > test_definition.json

```

```{bash eval=FALSE}

aws quicksight describe-dashboard --dashboard-id '478158c8-17cd-4954-b0bd-d9f733b7b30a' --aws-account-id xxxxxxxxxxxx > dashboard.json
...
available_datasets = query_dynamodb_for_datasets(dynamodb_client, dynamodb_table, '20200215382')
...
summary, force_flow, embark, cosi, cosi_embark, cosii_vii, cosii_vii_embark, cosiiip, cosiip_embark, cosiv, cosiv_embark, cosvi, cosvi_embark, cosix, cosix_embark
